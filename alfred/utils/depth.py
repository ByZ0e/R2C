...
if __name__ == '__main__':
    dir = '/home/lm2/projects/Real2Chess_maskrcnn/visualization/pick_and_place_simple-Vase-None-Safe-219/trial_T20190908_205221_748352/0/depth_images/000000001.png'
    depth_image = cv2.imread(dir, cv2.IMREAD_COLOR)
    depth_add_noise = apply_real_noise(depth_arr=depth_image, size=300)
    print(depth_add_noise.shape)
    
    result = cv2.imwrite('depth_01.png', depth_add_noise)
